/*
 * Copyright (c) 12/21/19 3:49 PM Evren Coşkun
 *
...
class MockModel {
    companion object {
        ...
        val mockHourlyList = createMockHourlyList()
        val mockErrorList = createMockErrorList()
        ...
        private fun createMockApiResponse(): ApiResponse {
            return ApiResponse(Data(mockWeatherList, mockErrorList))
        }

        private fun createMockWeatherList(): List<Weather> {
            return listOf(
                Weather("21,12,2019", 30, 20, mockHourlyList),
                Weather("22,12,2019", 30, 20, mockHourlyList),
                Weather("23,12,2019", 30, 20, mockHourlyList)
            )
        }
